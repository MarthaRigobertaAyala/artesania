...
<form class="" id="frm_editar_envio" action=" <?php echo site_url(); ?>/envios/guardar" method="post">
    <div class="row">
      <input type="text" name="id_env" id="env" class="form-control" value="<?php echo $envioEditar->id_env; ?>">
      <div class="col-md-4">
