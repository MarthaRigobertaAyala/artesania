...
<form class="" id="frm_editar_cliente" action="<?php echo site_url('clientes/procesarActualizacion') ?>" method="post">
    <div class="row">
    <input type="text" name="id_cli" id="cli" class="form-control" value="<?php echo $clienteEditar->id_cli; ?>">
      <div class="col-md-4">
          ...
          <input type="number"
            ...
            required
            min="99999999"
            name="cedula_cli" value="<?php echo $clienteEditar->cedula_cli; ?>" id="cedula_cli">
      </div>
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="primer_nombre_cli" value="<?php echo $clienteEditar->primer_nombre_cli; ?>"  id="primer_nombre_cli">
      </div>
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="primer_apellido_cli" value="<?php echo $clienteEditar->primer_apellido_cli; ?>"  id="primer_apellido_cli">
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="telefono_cli" value="<?php echo $clienteEditar->telefono_cli; ?>"  id="telefono_cli">
      </div>
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="estado_civil_cli" value="<?php echo $clienteEditar->estado_civil_cli; ?>" id="estado_civil_cli">
      </div>
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="correo_cli" value="<?php echo $clienteEditar->correo_cli; ?>"  id="correo_cli">
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        required
        class="form-control"
        name="direccion_cli" value="<?php echo $clienteEditar->direccion_cli; ?>"  id="direccion_cli">
      </div>
    </div>
    <br>
    <div class="row">
