<h1 class="text-center">EDITAR DATOS DE PEDIDOS</h1>
<form class="" id="frm_editar_pedido" action="<?php echo site_url('pedidos/procesarActualizacion') ?>" method="post">
    <div class="row">
      <input type="text" name="id_ped" id="ped" class="form-control" value="<?php echo $pedidoEditar->id_ped; ?>">
      <div class="col-md-4">
          <label for="articulo_ped" class="form-label">Articulo: <span class="obligatorio"> (obligatorio)</span></label>
          <select required id="articulo_ped" class="form-control" name="articulo_ped" value="<?php echo $pedidoEditar->articulo_ped; ?>">
      ...
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="descripcion_ped" value="<?php echo $pedidoEditar->descripcion_ped; ?>"  id="descripcion_ped">
      </div>
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="color_ped" value="<?php echo $pedidoEditar->color_ped; ?>" id="color_ped">
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col-md-4">
        ...
        <select required id="tamaño_ped" class="form-control" name="tamaño_ped" value="<?php echo $pedidoEditar->tamaño_ped; ?>">
      ...
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="telefono_ped" value="<?php echo $pedidoEditar->telefono_ped; ?>" id="telefono_ped">
      </div>
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="direccion_ped" value="<?php echo $pedidoEditar->direccion_ped; ?>"id="direccion_ped">
      </div>
    </div>
    <br>
    <div class="row">
