...
<form class="" id="frm_editar_ubicacion" action="<?php echo site_url('ubicaciones/procesarActualizacion') ?>" method="post">
    <div class="row">
      <input type="text" name="id_ubi" id="ubi" class="form-control" value="<?php echo $ubicacionEditar->id_ubi; ?>">
      <div class="col-md-4">
      <label for="pais_ubi" class="form-label">Pais: <span class="obligatorio"> (obligatorio)</span> </label>
      <select required id="pais_ubi" class="form-control" name="pais_ubi" value="<?php echo $ubicacionEditar->pais_ubi; ?>">
      ...
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="provincia_ubi"value="<?php echo $ubicacionEditar->provincia_ubi; ?>" id="provincia_ubi">
      </div>
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="canton_ubi" value="<?php echo $ubicacionEditar->canton_ubi; ?>" id="canton_ubi">
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col-md-4">
        ...
        required
        class="form-control"
        name="ciudad_ubi" value="<?php echo $ubicacionEditar->ciudad_ubi; ?>" id="ciudad_ubi">
      </div>
      <div class="col-md-4">
          ...
          required
          class="form-control"
          name="calle_ubi" value="<?php echo $ubicacionEditar->calle_ubi; ?>" id="calle_ubi">
      </div>
      <div class="col-md-4">
        ...
        required
        name="telefono_ubi" value="<?php echo $ubicacionEditar->telefono_ubi; ?>" id="telefono_ubi">
      </div>
    </div>
    <br>
    <div class="row">
