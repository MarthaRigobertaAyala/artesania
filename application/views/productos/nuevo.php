...
<form class="" id="frm_nuevo_producto"  action=" <?php echo site_url(); ?>/productos/guardar" method="post">
    <div class="row">
      <div class="col-md-4">
        <label for="nombre_productos_pro" class="form-label">PRODUCTOS: <span class="obligatorio"> (obligatorio)</span> </label>
      ...
      <div class="col-md-4">
        <label for="cantidad_produtos_pro" class="form-label">CANTIDAD: <span class="obligatorio"> (obligatorio)</span> </label>
